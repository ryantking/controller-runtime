...
**A**: The fake client
[exists](https://pkg.go.dev/github.com/ryantking/controller-runtime/pkg/client/fake),
but we generally recommend using
[envtest.Environment](https://pkg.go.dev/github.com/ryantking/controller-runtime/pkg/envtest#Environment)
...
docs](https://pkg.go.dev/github.com/ryantking/controller-runtime/pkg/scheme) for
more information.
